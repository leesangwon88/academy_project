        ...
        <div class="join_rap">
            ...
            <div class="join_area">
                <form action="newMemberCheck.go" method="post" name="form" onsubmit="return memberCheck();">
                        ...
                        <tr>
                            <td>
                                <div class="member_type">
                                    <input type="radio" name="member_type" id="member_lifetime" checked><label for="member_lifetime">평생회원</label><input type="radio" name="member_type" id="member_normal"><label for="member_normal">일반회원</label>
                                </div>
                    ...
                    <div class="agreement_box">
                        <div class="all_check">
                            <input type="checkbox" id="allCheck"><label for="allCheck">전체동의</label>
                        </div>
                        <div class="agreement_detail">
                            <div class="deail_list1">
                                <span><input type="checkbox" id="check1"><label for="check1">이용약관</label><a href="">내용보기</a></span>
                                <span><input type="checkbox" id="check2"><label for="check2">개인정보 수집 및 이용 안내</label><a href="">내용보기</a></span>
                                <span><input type="checkbox" id="check3"><label for="check3">내용보기</label></span>
                            </div>
                            <p class="warning">*SMS 수신거부시 입고지연 / 품절안내 문자의 전송이 불가하여 발생하는 불이익은 책임지지 않습니다.</p>
                            <div class="deail_list2">
                                <span class="marketing_check"><input type="checkbox" id="check4"><label for="check4">마케팅 수신동의</label></span>(<span><input type="checkbox" id="check5"><label for="check5">이메일</label></span><span class="check6"><input type="checkbox" id="check6"><label for="check6">SMS</label></span><span><input type="checkbox" id="check7"><label for="check7">앱Push알림</label></span>)
                            </div>
                            <p class="info">쇼핑몰에서 제공하는 신상품 소식/ 할인쿠폰을 무상으로 보내드립니다!<br>단, 상품 구매 정보는 수신동의 여부 관계없이 발송됩니다.<br><strong>제공 동의를 하지 않으셔도 서비스 이용에는 문제가 없습니다.</strong></p>
                        </div>
                    </div>
                    <div class="join_btn">
                        <button>가입완료</button>
            ...
            <div class="join_info_area clear">
                <div class="join_info1">
                    <h3>이용약관</h3>
                    <textarea>
 인터넷 쇼핑몰 『 주식회사 디에스 사이버 몰』회원 약관 

제1조(목적)
 이 약관은 주식회사 디에스 회사(전자상거래 사업자)가 운영하는 주식회사 디에스 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
①"몰" 이란 주식회사 디에스 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
②"이용자"란 "몰"에 접속하여 이 약관에 따라 "몰"이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
③ '회원'이라 함은 "몰"에 개인정보를 제공하여 회원등록을 한 자로서, "몰"의 정보를 지속적으로 제공받으며, "몰"이 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.
④ '비회원'이라 함은 회원에 가입하지 않고 "몰"이 제공하는 서비스를 이용하는 자를 말합니다.

제3조 (약관등의 명시와 설명 및 개정) 
① "몰"은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 주식회사 디에스 사이버몰의 초기 서비스화면(전면)에 게시합니다.다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
⑥ 이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 자상거래등에서의소비자보호에관한법률, 약관의규제등에관한법률, 정거래위원회가 정하는 전자상거래등에서의소비자보호지침 및 관계법령 또는 상관례에 따릅니다.
...
② 수신확인통지를 받은 이용자는 의사표시의 불일치등이 있는 경우에는 수신확인통지를 받은 후 즉시 구매신청 변경 및 취소를 요청할 수 있고 "몰"은 배송전에 이용자의 요청이 있는 경우에는 지체없이 그 요청에 따라 처리하여야 합니다. 다만 이미 대금을 지불한 경우에는 제15조의 청약철회 등에 관한 규정에 따릅니다.
 ...
 제13조(재화등의 공급)
① "몰"은 이용자와 재화등의 공급시기에 관하여 별도의 약정이 없는 이상, 이용자가 청약을 한 날부터 7일 이내에 재화 등을 배송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다. 다만, "몰"이 이미 재화 등의 대금의 전부 또는 일부를 받은 경우에는 대금의 전부 또는 일부를 받은 날부터 2영업일 이내에 조치를 취합니다.  이때 "몰"은 이용자가 재화등의 공급 절차 및 진행사항을 확인할 수 있도록 적절한 조치를 합니다.
...
④"몰"이 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 인정보관리 책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공 관련사항(제공받은자, 제공목적 및 제공할 정보의 내용) 등 정보통신망이용촉진등에관한법률 제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수 있습니다.
...
제25조(적립금과 예치금)
①"적립금과 예치금은 "몰"내에서 현금처럼 사용되는 전자화폐이며, 상품 구매시에만 이용할 수 있습니다.
②"예치금은 회원에 한하여 제공되는 서비스이며 신용카드,모바일, 현금을 이용하여 지불할 수 있습니다.
③"적립금은 회원에 한하여 제공되는 서비스입니다.
④"적립금과 예치금은 타 결제수단(신용카드,모바일,현금)과 함께 사용될 수 있습니다.
⑤"회사는 각종 할인이벤트 또는 제휴이벤트 등의 특정기간에는 적립금 또는 예치금의 신청 및 이용을 제한할 수 있습니다
⑥"회원이 상품구매나 이벤트 등을 통하여 회사로부터 무상 제공받은 적립금의 경우 회사에서 정한 기한에 한해서만 이용 가능합니다.
⑦"유효기간 : 회사로부터 제공받은 적립금의 경우 회사가 별도로 유효기간을 정한 때에는 이에 따릅니다. 유효기간이 경과한 적립금은 자동적으로 소멸하게 됩니다
⑧"적립금 소멸일 기준으로 1년이상 경과된 적립금에 대해 "몰"은 해당 회원의 적립된 적립금을 회수하게 됩니다
1) 삭제 대상 회원 : 8번 항목에 작성된 삭제 조건에 부합하는 회원
2) 해당 조건에 부합하는 회원의 경우, 해당기간이 지난 후 자동적으로 적립금 소멸됨

[카카오톡 알림톡 시행에 관한 내용]
“주식회사 디에스”은 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자메시지로 보내드립니다. 카카오톡 알림톡을 통해 안내되는 정보를 이파이가 아닌 이동통신망으로 이용할 경우, 알림톡 수신 중 데이터 요금이 생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다.

[카카오톡 상담톡 시행에 관한 내용]
“주식회사 디에스”은 상담업무를 카카오톡 상담톡으로 진행하며, 만약 카카오톡을 통해 안내되는 상담 내용을 Wi-Fi 나 PC가 아닌 이동통신망으로 이용할 경우, 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 상담을 원치 않으실 경우 고객센터, 게시판 문의를 이용해 주시기 바랍니다.
본 약관은 2006년11월11일부터 적용됩니다.
                    </textarea>
                </div>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th>목적</th>
                                <th>항목</th>
                                <th class="row4">보유기간</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="row1" rowspan="4">필수정보</td>
                                <td>회원제 서비스 이용 / 본인확인</td>
                                <td>이름, 아이디, 비밀번호, 생일, 성별, 이메일, 주소, 휴대폰</td>
                                <td class="row4">회원탈퇴 후<br> 5일까지</td>
                            </tr>
                            <tr>
                                <td>회원제 서비스 이용</td>
                                <td>연락처, SMS인증번호, 추천인 아이디</td>
                                <td class="row4">회원탈퇴 후<br> 5일까지</td>
                            </tr>
                            <tr>
                                <td>회원 주문 서비스 이용</td>
                            ...
                            <tr>
                                <td class="row1" rowspan="3">선택정보</td>
                                <td>마케팅 활용(이벤트, 맞춤형 광고)</td>
                                <td>휴대폰, 이메일, 쿠키정보</td>
                                <td class="row4">회원탈퇴 후<br> 5일까지</td>
                            </tr>
                            <tr>
                                <td>상품 이용후기작성/고객상담</td>
                                <td>의류사이즈, 신발사이즈, 키, 몸무게, 개인식별사진</td>
                                <td class="row4">회원탈퇴 후<br> 5일까지</td>
                            </tr>
                            <tr>
                                <td>상품 환불서비스 이용</td>
                ...
                <div class="join_info3">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>(주)유니드컴즈</td>
                                <td>회원정보 DB 시스템 운영 및 관리, 디지털 마케팅 자동화 업무</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            </div>
            <p>귀하께서는 쇼핑몰에서 위와 같이 수집하는 개인정보에 대해, 동의하지 않거나 개인정보를 기재하지 않음으로써 거부할 수 있습니다.<br>다만, 이때 회원에게 제공되는 서비스가 제한될 수 있습니다.</p>
        </div>
    </div>
